...
train_data_dir=data/sp_exp/train_5_2sp_hires
test_data_dir=data/${test_sets}_hires
train_ivector_dir=exp/nnet3/sp_exp/ivectors_train_5_2sp_hires


dir=exp/nnet3/sp_exp/blstm/layer${num_lstm_layers}_epoch${num_epochs}_celldim${cell_dim}_rp${3}_lr0.0004_sp5_2

if [ $label_delay -gt 0 ]; then dir=${dir}_ld$label_delay; fi



progress/nnet3/run_ivector_common_exp_sp.sh --stage $stage --nj $nj \ 
