...
if [ $# != 4 ]; then
  echo "Usage: $0 [opts] <data> <test-data> <ali-dir> <egs-dir>"
  echo " e.g.: $0 data/train data/test exp/tri3_ali exp/tri4_nnet/egs"
  echo ""
...
for f in $data/feats.scp $testdata/feats.scp \
  $alidir/ali.1.gz $alidir/final.mdl $alidir/tree $extra_files; do
...
case $feat_type in
  raw) feats="ark,s,cs:utils/filter_scp.pl $dir/train_uttlist $sdata/JOB/feats.scp | apply-cmvn $cmvn_opts --utt2spk=ark:$sdata/JOB/utt2spk scp:$sdata/JOB/cmvn.scp scp:- ark:- |"
    valid_feats="ark,s,cs:utils/filter_scp.pl $dir/valid_uttlist $testdata/feats.scp | apply-cmvn $cmvn_opts --utt2spk=ark:$testdata/utt2spk scp:$testdata/cmvn.scp scp:- ark:- |"
  ...
  lda) 
    ...
    valid_feats="ark,s,cs:utils/filter_scp.pl $dir/valid_uttlist $testdata/feats.scp | apply-cmvn $cmvn_opts --utt2spk=ark:$testdata/utt2spk scp:$data/cmvn.scp scp:- ark:- | splice-feats $splice_opts ark:- ark:- | transform-feats $dir/final.mat ark:- ark:- |"
