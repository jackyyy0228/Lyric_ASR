...
pitch_postprocess_config=conf/pitch_posprocess.conf
...
ori_feats="ark,s,cs:apply-cmvn $cmvn_opts --utt2spk=ark:$sdata/JOB/utt2spk scp:$sdata/JOB/cmvn.scp scp:$sdata/JOB/feats.scp ark:- | add-deltas ark:- ark:- |"
pitch_feats="ark,s,cs:compute-kaldi-pitch-feats --verbose=2 --config=$pitch_config scp,p:$sdata/JOB/wav.scp ark:- | process-kaldi-pitch-feats $postprocess_config_opt ark:- ark:- |"
$cmd JOB=1:$nj $dir/log/make_exten_pitch.JOB.log \
...
feats="ark,s,cs:$dir/log/raw_exten_pitch.JOB.ark";
case $feat_type in
  delta) feats="ark,s,cs:$dir/log/raw_exten_pitch.JOB.ark";;
  lda) feats="ark,s,cs:splice-feats $splice_opts ark:$dir/log/raw_exten_pitch.JOB.ark ark:- | transform-feats $srcdir/final.mat ark:- ark:- |";;
