...
srcdir=exp/nnet3/lstm_bidirectional/
train_data_dir=data/paper/train_clean_utt_sp_hires
online_ivector_dir=exp/nnet3/ivectors_paper/train_clean_utt_sp_hires
