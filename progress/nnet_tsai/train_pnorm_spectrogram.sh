...
trainset=data/paper/train_clean_utt_spectrogram
testset=data/paper/test_clean_utt_spectrogram
...
EOF
  ...
  minibatch_size=128
  dir=exp/paper/nnet_spectrogram/layer${num_layer}_$1\_$2\_epoch${epoch}
fi
...
if [ ! -f $dir/final.mdl ]; then
   ...
   local/nnet2/train_pnorm_fast_spectrogram.sh --stage $train_stage \
