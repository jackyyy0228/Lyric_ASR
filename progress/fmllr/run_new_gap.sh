...
numjob=1 
expid=exp2
trainingdata=$datadir/vocal/new_genre_train_clean
testingdata=$datadir/vocal/new_genre_test_clean
...
if [ $stage -le 6 ]; then
  ...
  ali=$expdir/genre/new_gat/tri2b_ali_genre
...
if [ $stage -le 7 ]; then
  ...
  lm=$datadir/lang_lyric
  ali=$expdir/genre/new_gat/tri2b_ali_genre
  mdl=$expdir/genre/new_gat/tri3b_genre
