...
trainset=data/paper/train_clean_utt_fbank_energy
testset=data/paper/test_clean_utt_fbank_energy
...
EOF
  ...
  minibatch_size=128
  dir=exp/paper/nnet_fbank/layer${num_layer}_$1\_$2\_epoch${epoch}
fi
