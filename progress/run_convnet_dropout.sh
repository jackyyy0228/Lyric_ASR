...
numf2=$3
epoch=$4
dir=exp/nnet2_cnn/mel40/dim150/epoch${epoch}_hidden_size_${hiddensize}_numf1_${numf1}_numf2_${numf2}_lr0.005_dropout
stage=-5
...
( 
  if [ ! -f $dir/final.mdl ]; then
    steps/nnet2/train_convnet_accel3_dropout.sh --parallel-opts "$parallel_opts" \
      ...
      --initial-effective-lrate 0.007 --final-effective-lrate 0.0007 \
