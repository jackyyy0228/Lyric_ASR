...
num_epochs_extra=5 # Number of epochs after we stop reducing
                   # the learning rate.
num_iters_final=15 # Maximum number of final iterations to give to the
...
pnorm_input_dim_layer3=50
pnorm_output_dim_layer3=50
p=2
...
DropoutComponent dim=$lda_dim dropout-proportion=0.5 dropout-scale=0.0
...
DropoutComponent dim=$pnorm_output_dim dropout-proportion=0.5 dropout-scale=0.0
