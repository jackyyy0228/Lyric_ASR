...
case $feat_type in
  delta) sifeats="ark,s,cs:apply-cmvn $cmvn_opts scp:$sdata/JOB/cmvn.scp scp:$sdata/JOB/feats.scp ark:- | add-deltas $delta_opts ark:- ark:- |";;
  lda) sifeats="ark,s,cs:apply-cmvn $cmvn_opts scp:$sdata/JOB/cmvn.scp scp:$sdata/JOB/feats.scp ark:- | splice-feats $splice_opts ark:- ark:- | transform-feats $srcdir/final.mat ark:- ark:- |";;
...
pass1feats="$sifeats transform-feats ark:$dir/pre_trans.JOB ark:- ark:- |"
