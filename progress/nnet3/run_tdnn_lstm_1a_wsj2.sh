...
dir=exp/nnet3/tdnn_lstm2/epoch${epoch}_tdnndim${tdnndim}_rpdim${rpdim}
...
if [ $stage -le 12 ]; then
  ...
  output-layer name=output input=lstm2 output-delay=$label_delay dim=$num_targets max-change=1.5
